...
return [
    ...
    'douyin'               => [
        ...
        'client_secret' => 'b12e82a3a4e09e82ed2f9c6fde47a292',
        'base_url'      => 'https://open.douyin.com', // 抖音开放平台域名
        'poi_id'        => '7571901790183065635', // 可配置多个7571901790183065635    7187651466377578553
    ],                      
    ...
    'mqtt' => 
        ...
        // MQTT服务器配置
        'server' => [
            'host' => '122.51.106.231', // 支持环境变量配置
            'port' => 1883,
            'username' => 'BNFDfLZjFVjf1',
            'password' => 'HEZfSYZfAohhdRRLCr1',
            'keepalive' => 60, // 心跳间隔(秒)
            'timeout' => 10,   // 连接超时(秒)
        ],
        // 订阅的主题配置（主题 => QoS等级）
        'topics' => [
            'device/+/response' => 0, // 设备指令响应
            'device/+/status' => 0,   // 设备状态上报
            'device/+/event' => 1,    // 设备事件通知（QoS 1确保送达）
        ],
        // 监听配置
        'listen' => [
            'retry_interval' => 5, // 断线重试间隔(秒)
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'cYGDl59VZ0Uh1LCIaNAP6JwSbjfFzyk4',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
