...
class Auth
{
    ...
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id', 'username', 'nickname', 'mobile', 'avatar', 'score', 'roleType', 'agentType', 'businessLicense', 'isIntermediary', 'isFactory', 'idCardFrontImgUrl', 'idCardBackImgUrl'];
